...
func toStatState(st SectorState, finEarly bool) statSectorState {
	...
	case UndefinedSectorState, Empty, WaitDeals, AddPiece, AddPieceFailed:
		return sstStaging
	case Packing, GetTicket, PreCommit1, PreCommit2, PreCommitting, PreCommitWait, SubmitPreCommitBatch, PreCommitBatchWait, WaitSeed, Committing, WaitCommit2, CommitFinalize, FinalizeSector:
		return sstSealing
